...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post exercises_url, params: { exercise: { equipment: @exercise.equipment, name: @exercise.name, target: @exercise.target } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { equipment: @exercise.equipment, name: @exercise.name, target: @exercise.target } }
